...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'coupon', 'services', 'room_equipment', 'data', 'start_time', 'end_time',
            'internal_notes', 'treatment_record_marking', 'treatment_record_customer_file', 'state'
        ]
        extra_kwargs = {
    ...
    def validate(self, data):
        ...
        # if professional and getattr(professional, 'role', None) in ['professional', 'customer']:
    ...
    def update(self, instance, validated_data):
        for attr in ['title', 'professional', 'customer', 'coupon', 'services', 'room_equipment',
    ...
    def send_booking_email(self, booking, action):
        ...
        subject = f"Booking {action.capitalize()} Notification"
        time_text = ''
        if booking.start_time and booking.end_time:
            time_text = f" from {booking.start_time} to {booking.end_time}"
        message = f"Your booking for {booking.data}{time_text} has been {action}."
